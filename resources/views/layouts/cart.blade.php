...
<div id="cartSidebar"
    ...
    <div class="h-full flex flex-col">
        ...
        <div class="p-6 border-t border-gray-200 dark:border-gray-700">
            ...
            <div class="space-y-3">
                <!-- <button id="viewCart"
                    class="w-full py-3 border border-primary text-primary rounded-lg font-bold hover:bg-primary hover:text-white transition-all-300">
                    View Cart Details
                </button> -->
                <button id="checkoutBtn"
                    class="w-full py-3 bg-primary text-white rounded-lg font-bold hover:bg-blue-700 transition-all-300 flex items-center justify-center">
            ...
            <div class="mt-6 text-center">
                <a href="#" class="text-primary font-medium hover:underline continue-shopping" data-page="products">
